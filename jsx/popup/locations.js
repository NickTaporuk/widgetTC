            ...
            Object.keys(locations).forEach(function(locationId, i) {
                ...
                locationEls.push((
                    <li key={i}>
                        ...
                        <button onClick={this._handleSelectClick.bind(this, location.id)} disabled={ currentLocation && location.id === currentLocation.id } className={cn(['brand_btn', 'btn_small', 'location_btn'])}>
                            {currentLocation && location.id === currentLocation.id ? 'Selected location' : 'Select this location' }
                        </button>
                    </li>
                ));
            }, this);
